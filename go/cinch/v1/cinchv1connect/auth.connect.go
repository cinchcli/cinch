...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/cinchcli/cinch-core/go/cinch/v1"
	http "net/http"
	strings "strings"
)
...
func (c *authServiceClient) SetDisplayName(ctx context.Context, req *connect.Request[v1.SetDisplayNameRequest]) (*connect.Response[v1.SetDisplayNameResponse], error) {
...
func (UnimplementedAuthServiceHandler) SetDisplayName(context.Context, *connect.Request[v1.SetDisplayNameRequest]) (*connect.Response[v1.SetDisplayNameResponse], error) {
